...
export const isUserVisibleMutation = (type: TransferrableMutationType): boolean => {
  switch (type) {
    ...
    case TransferrableMutationType.WINDOW_ON_BEFORE_UNLOAD:
      return false;
    default:
      return true;
  }
...
export const DefaultAllowedMutations = [
  ...
  TransferrableMutationType.WINDOW_ON_BEFORE_UNLOAD,
];
